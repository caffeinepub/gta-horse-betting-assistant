...
export class Backend implements backendInterface {
    ...
    async getROI(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getROI();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRaceHistory(): Promise<Array<Race>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRaceHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrustWeights(): Promise<Array<[OddsRange, number]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrustWeights();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getValueBets(arg0: Array<Horse>): Promise<Array<Horse>> {
        if (this.processError) {
            try {
                const result = await this.actor.getValueBets(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logRace(arg0: Array<Horse>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logRace(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
